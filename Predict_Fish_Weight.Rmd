...
Both graphs show that as length1 increases ,weight follows and increases as well. It looks like a straight line is not a great fit because most of the points don't fall evenly around the blue line. We still need more tests to find the best two variables. 
...
width;it shows that the best prediction for weight=-536 + 74.77 * Height +69.62 *width.
...
eases weight follows and increases as well. It looks like a straight line is not a great fit because most of the points don't fall evenly around the blue line. We need more test to find the best two variables
